...
console.log(`Is Adult: ${__WEBPACK_IMPORTED_MODULE_0__person_js__["c" /* isAdult */](18)}`)
console.log(`Can Drink: ${__WEBPACK_IMPORTED_MODULE_0__person_js__["a" /* canDrink */](18)}`)
